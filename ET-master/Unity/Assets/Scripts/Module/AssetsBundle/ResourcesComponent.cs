...
namespace ETModel
{
	...
	public class ResourcesComponent : Component
	{
		...
		public void LoadOneBundle(string assetBundleName)
		{
            ...
            //"E:/ET-master/Unity/Assets/StreamingAssets/code.unity3d";
            string p = PathHelper.AppHotfixResPath+"/"+assetBundleName;// Path.Combine(PathHelper.AppHotfixResPath, assetBundleName);
